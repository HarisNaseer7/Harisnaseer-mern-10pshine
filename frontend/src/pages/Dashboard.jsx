...
import { getNotes, deleteNote, pinNote, archiveNote, trashNote, restoreNote } from '../services/api';
                ...
                <div key={note._id} style={{ background: cardBg, borderRadius: '12px', border: `1px solid ${cardBorder}`, padding: '16px', position: 'relative' }}
                  ...
                  <div style={{ marginBottom: '10px' }}>
                    {(() => {
                      ...
                      return (
                        <span style={{ fontSize: '11px', padding: '3px 8px', background: cat.color + '20', color: cat.color, borderRadius: '20px', fontWeight: 500 }}>
                          {cat.label}
                        </span>
                      );
                    })()}
